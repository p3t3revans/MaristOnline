...
!function(app){"use strict";app.registerModule("articles",["core"]),app.registerModule("articles.services"),app.registerModule("articles.routes",["ui.router","articles.services"])}(ApplicationConfiguration);
!function(app){"use strict";app.registerModule("artists",["core"]),app.registerModule("artists.services"),app.registerModule("artists.routes",["ui.router","artists.services"])}(ApplicationConfiguration);
...
!function(app){"use strict";app.registerModule("mediums",["core"]),app.registerModule("mediums.services"),app.registerModule("mediums.routes",["ui.router","mediums.services"])}(ApplicationConfiguration);
!function(app){"use strict";app.registerModule("pictures",["core"]),app.registerModule("pictures.services"),app.registerModule("pictures.routes",["ui.router","pictures.services"])}(ApplicationConfiguration);
!function(app){"use strict";app.registerModule("subjects",["core"]),app.registerModule("subjects.services"),app.registerModule("subjects.routes",["ui.router","subjects.services"])}(ApplicationConfiguration);
!function(app){"use strict";app.registerModule("teachers",["core"]),app.registerModule("teachers.services"),app.registerModule("teachers.routes",["ui.router","teachers.services"])}(ApplicationConfiguration);
!function(app){"use strict";app.registerModule("users"),app.registerModule("users.admin"),app.registerModule("users.services"),app.registerModule("users.admin.services"),app.registerModule("users.routes",["ui.router"]),app.registerModule("users.admin.routes",["ui.router","users.admin.services"])}(ApplicationConfiguration);
!function(app){"use strict";app.registerModule("years",["core"]),app.registerModule("years.services"),app.registerModule("years.routes",["ui.router","years.services"])}(ApplicationConfiguration);
!function(){"use strict";function menuConfig(Menus){Menus.addMenuItem("topbar",{title:"Articles",state:"articles",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","articles",{title:"List Articles",state:"articles.list"}),Menus.addSubMenuItem("topbar","articles",{title:"Create Article",state:"articles.create",roles:["teach","admin"]})}angular.module("articles").run(menuConfig),menuConfig.$inject=["Menus"]}();
