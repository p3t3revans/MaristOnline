 ...
 * Module dependencies
 */
var path = require('path'), mongoose = require('mongoose'), Teacher = mongoose.model('Teacher'), errorHandler = require(path.resolve('./modules/core/server/controllers/errors.server.controller'));
/**
 * Create an teacher
 */
