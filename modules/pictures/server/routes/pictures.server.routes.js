 ...
 * Module dependencies
 */
var picturesPolicy = require('../policies/pictures.server.policy'), pictures = require('../controllers/pictures.server.controller');
module.exports = function (app) {
    ...
    // pictures front page routes
    app.route('/api/picturesbyartist/:artistId/page/:page/count/:count').all(picturesPolicy.isAllowed)
        .get(pictures.picturesByArtistList);
    // pictures front page routes
    app.route('/api/picturesbyyear/:year/page/:page/count/:count').all(picturesPolicy.isAllowed)
